...
<div id="box">
  ...
  <form name="add" method="post" action="?page=tambah_barangpro" enctype="multipart/form-data">
    ...
    <table class="article">
      ...
      <tr>
        <td>Deskripsi Case HP</td>
        <td>
          <input type="text" name="deskripsi" size="50" placeholder="ex: ~kyood 1~ custom case all type" required>
        </td>
      </tr>
      ...
      <tr>
        <td>Harga</td>
        <td>
          <input type="text" name="harga" size="50" placeholder="ex: 40000" required>
        </td>
      </tr>
