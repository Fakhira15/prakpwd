...
<?php
    ...
    try {
      ...
      $insert = $conn->prepare("INSERT INTO tbl_pesanan (id_user,id_barang,notes,qty,kurir,date_in,total) SELECT id_user,id_barang,notes,qty,kurir,date_in,total FROM tbl_keranjang WHERE id_user=:id");
  ...
  <table class="article">
    ...
    <tr>
      ...
      <td>
        ...
        BANK MANDIRI<br>
        Rekening : 123-456-789101-1<br>
        A.N : Kyoodicase<br>
        Referensi : bayar/id user/jersey <b>contoh : bayar/<?php echo $id."/casehp"; ?></b>
      </td>
    </tr>
    <tr>
      <td>Lanjutan</td>
    ...
    <tr>
      <td></td>
      <td>
        Terima kasih telah membeli case hp di website kami <br>
